    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {"role": "system",
             "content": prompt},
            {"role": "user",
             "content": """Provide an explanation to the human (don't be verbose) to address their confusion."""}
        ]
    )
...
#     source_of_confusion = generate_confusion(human_clarification_prompt)
...
#         '''
    ...
    source_of_confusion = generate_confusion(confusion_prompt).content
    print("Source of confusion: ", source_of_confusion)

    explanation_prompt = f'''
        The robot carried out this plan. As the robot was loading the dishwasher, 
        the human asked the following question: \"{human_clarification_question}\",
        the human's likley confusion is \"{source_of_confusion}\"
        '''

    explanation = generate_explanation(explanation_prompt).content
